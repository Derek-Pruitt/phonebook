...
class ParentWindow(Frame):
    def __init__(self,master,*args,**kwargs):
        ...
        # this is a tkinter built-in method to catch if
        # the user clicks the upper corner, "x" on windows os
        self.master.protocol("Wm_DELETE_WINDOW",lambda: phonebook_fun.ask_quit(self))
        arg = self.master

        # load in the GUI widets from a separate module,
        # kepping code comparmentalized and clutter free
        phonebook_gui.load_gui(self)
...
>>>>>>> 27380f55596702c1dcbc5524299254538c0d2e29
